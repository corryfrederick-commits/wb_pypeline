...
with latest_raw as (
    ...
    where dataset_name = 'report_sales'
    order by
        client_id,
        wb_account_id,
        source_system,
...
typed as (
    ...
    select
        ...
        staging.try_numeric(raw_record #>> '{forPay}') as for_pay,
        ...
        staging.try_bigint(raw_record #>> '{paymentSaleAmount}') as payment_sale_amount,
        ...
        nullif(raw_record #>> '{saleID}', '') as sale_id,
