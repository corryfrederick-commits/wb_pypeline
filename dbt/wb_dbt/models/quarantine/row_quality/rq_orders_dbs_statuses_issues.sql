{{ config(materialized='table', schema='quarantine', alias='rq_orders_dbs_statuses_issues', tags=['row_quality']) }}

with base as (
    select *
    from {{ ref('stg_orders_dbs_statuses') }}
),
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__technical_raw_payload_id_missing'::text as rule_id,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__technical_record_index_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__technical_dataset_name_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__technical_raw_record_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__duplicate_raw_payload_record_index'::text as rule_id,
    'technical_lineage'::text as rule_group,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__unexpected_dataset_name'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'accepted_dataset'::text as rule_type,
    'bad'::text as issue_severity,
    'dataset_name'::text as column_name,
    'unexpected_dataset_name'::text as issue_code,
    'dataset_name is not `orders_dbs_statuses`.'::text as issue_message,
    current_timestamp as detected_at
from (
    select
        base.*,
        (dataset_name <> 'orders_dbs_statuses') as is_issue
    from base
) q
where q.is_issue is true
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__order_status_identity_missing'::text as rule_id,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__wb_status_missing'::text as rule_id,
    'domain_required'::text as rule_group,
    'required'::text as rule_type,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__supplier_status_missing'::text as rule_id,
    'domain_required'::text as rule_group,
    'required'::text as rule_type,
    'warning'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_orders_dbs_statuses__status_missing'::text as rule_id,
    'domain_required'::text as rule_group,
    'required'::text as rule_type,
    'warning'::text as issue_severity,
