{{ config(materialized='table', schema='quarantine', alias='rq_finance_sales_reports_issues', tags=['row_quality']) }}

with base as (
    select *
    from {{ ref('stg_finance_sales_reports') }}
),
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__technical_raw_payload_id_missing'::text as rule_id,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__technical_record_index_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__technical_dataset_name_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__technical_raw_record_missing'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'required'::text as rule_type,
    'bad'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__duplicate_raw_payload_record_index'::text as rule_id,
    'technical_lineage'::text as rule_group,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__unexpected_dataset_name'::text as rule_id,
    'technical_lineage'::text as rule_group,
    'accepted_dataset'::text as rule_type,
    'bad'::text as issue_severity,
    'dataset_name'::text as column_name,
    'unexpected_dataset_name'::text as issue_code,
    'dataset_name is not `finance_sales_reports`.'::text as issue_message,
    current_timestamp as detected_at
from (
    select
        base.*,
        (dataset_name <> 'finance_sales_reports') as is_issue
    from base
) q
where q.is_issue is true
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__operation_date_missing'::text as rule_id,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__operation_business_identity_missing'::text as rule_id,
    'domain_required'::text as rule_group,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__converted_final_price_negative'::text as rule_id,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__converted_price_negative'::text as rule_id,
    'numeric_quality'::text as rule_group,
    'non_negative'::text as rule_type,
    'warning'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__final_price_negative'::text as rule_id,
    'numeric_quality'::text as rule_group,
    'non_negative'::text as rule_type,
    'warning'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__price_negative'::text as rule_id,
    'numeric_quality'::text as rule_group,
    'non_negative'::text as rule_type,
    'warning'::text as issue_severity,
...
select
    ...
    q.record_index,
    q.dataset_name,
    'stg_finance_sales_reports__sale_price_negative'::text as rule_id,
    'numeric_quality'::text as rule_group,
    'non_negative'::text as rule_type,
    'warning'::text as issue_severity,
